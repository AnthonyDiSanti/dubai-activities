...
describe('generated photo attribution catalog', () => {
  it('covers every deployed asset with the expected attribution mix', () => {
    ...
    expect(catalog.assets).toHaveLength(403);
    expect(filenames.size).toBe(403);
    ...
    expect(basisCounts.creator_credit).toBe(14);
    expect(basisCounts.source_credit).toBe(323);
